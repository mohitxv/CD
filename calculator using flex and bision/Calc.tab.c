...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_calculation = 19,               /* calculation  */
...
{
       0,    28,    28,    32,    33,    34,    35,    36,    43,    44,
      45,    46,    47,    48,    49,    56,    63
};
#endif
...
{
      15,   -15,   -14,   -13,     9,    11,    12,    13,    15,    15,
      37,    78,    15,    15,    15,    15,    15,    15,   -15,    22,
     -15,    15,    15,    15,    15,    15,    30,    38,    46,    54,
      62,    70,   -15,    -2,    -2,    16,    16,    16,   -15,   -15,
     -15,   -15,   -15,   -15
};
...
{
      18,    19,    12,    13,    26,    27,    28,    29,    30,    31,
      23,    24,    25,    33,    34,    35,    36,    37,     1,     2,
       3,     4,     5,     6,     7,    14,     8,    15,    16,    17,
      25,     9,    21,    22,    23,    24,    25,    20,     0,    32,
      21,    22,    23,    24,    25,     0,     0,    38,    21,    22,
      23,    24,    25,     0,     0,    39,    21,    22,    23,    24,
      25,     0,     0,    40,    21,    22,    23,    24,    25,     0,
       0,    41,    21,    22,    23,    24,    25,     0,     0,    42,
      21,    22,    23,    24,    25,     0,     0,    43,    21,    22,
      23,    24,    25
};

static const yytype_int8 yycheck[] =
{
       8,     9,    16,    16,    12,    13,    14,    15,    16,    17,
      12,    13,    14,    21,    22,    23,    24,    25,     3,     4,
       5,     6,     7,     8,     9,    16,    11,    16,    16,    16,
      14,    16,    10,    11,    12,    13,    14,     0,    -1,    17,
      10,    11,    12,    13,    14,    -1,    -1,    17,    10,    11,
      12,    13,    14,    -1,    -1,    17,    10,    11,    12,    13,
      14,    -1,    -1,    17,    10,    11,    12,    13,    14,    -1,
...
static const yytype_int8 yystos[] =
{
      ...
      19,    20,    16,    16,    16,    16,    16,    16,    20,    20,
       0,    10,    11,    12,    13,    14,    20,    20,    20,    20,
      20,    20,    17,    20,    20,    20,    20,    20,    17,    17,
      17,    17,    17,    17
};
...
#line 1181 "Calc.tab.c"
  ...
  case 14: /* expression: LOG '(' expression ')'  */
#line 49 "Calc.y"
                                 {
        if ((yyvsp[-1].fval) <= 0) {
...
#line 1193 "Calc.tab.c"
  ...
  case 15: /* expression: LN '(' expression ')'  */
#line 56 "Calc.y"
                                 {
        if ((yyvsp[-1].fval) <= 0) {
...
#line 1205 "Calc.tab.c"
  ...
  case 16: /* expression: SQRT '(' expression ')'  */
#line 63 "Calc.y"
                                 {
        if ((yyvsp[-1].fval) < 0) {
